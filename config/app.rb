...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-upload-demo.com'
  config.app_name = 'Volt-upload-demo'
  config.mailer.from = 'Volt-upload-demo <no-reply@volt-upload-demo.com>'
  ...
  #
  config.app_secret = 'doSFHVE8mEoi89rSD2J__9XXuh5saSrJp0TqqdgrExeYb0qpOdwKXZwyIjoAKQsLE_o'
